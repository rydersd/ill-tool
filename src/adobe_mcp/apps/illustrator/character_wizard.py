...
def run_wizard(
    ...
    from adobe_mcp.apps.illustrator.part_segmenter import segment_by_color, extract_parts
    from adobe_mcp.apps.illustrator.connection_detector import detect_connections
    from adobe_mcp.apps.illustrator.hierarchy_builder import build_hierarchy
    from adobe_mcp.apps.illustrator.object_classifier import classify_object
    from adobe_mcp.apps.illustrator.object_hierarchy import auto_pivots
