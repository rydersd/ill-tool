...
from adobe_mcp.apps.illustrator.utility.auto_correct import (
    _build_read_jsx,
    _build_export_jsx,
    _score_convergence,
    _find_closest_item,
...
def register(mcp):
    ...
    async def adobe_ai_drawing_orchestrator(params: DrawingOrchestratorInput) -> str:
        ...
        if params.source == "3d_pipeline":
            from adobe_mcp.apps.illustrator.threed.feedback_loop_3d import FeedbackLoop3D
...
"""
            ...
            from adobe_mcp.apps.illustrator.drawing.form_edge_extract import _build_place_jsx
