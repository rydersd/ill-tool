...
def register_drawing_tools(mcp):
    ...
    from adobe_mcp.apps.illustrator.drawing.path_completion import register as _r; _safe_register(_r, mcp)
    from adobe_mcp.apps.illustrator.drawing.shape_classify import register as _r; _safe_register(_r, mcp)
    from adobe_mcp.apps.illustrator.drawing.form_gradient import register as _r; _safe_register(_r, mcp)
