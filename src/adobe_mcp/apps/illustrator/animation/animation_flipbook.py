...
from adobe_mcp.apps.illustrator.animation.quick_pose import apply_quick_pose, POSE_VOCABULARY
...
def create_flipbook(
    ...
    for i, pose_name in enumerate(pose_names):
        ...
        # Resolve pose angles
        try:
            from adobe_mcp.apps.illustrator.animation.quick_pose import parse_pose_description
