# Wiki Index
> Auto-maintained. Last updated: 2026-04-11. Articles: 41. Words: ~95K.

## Recent
- 2026-04-11: [Blender Freestyle Pipeline](concepts/blender-freestyle-pipeline.md) — Ground-truth render passes from Blender replace ML inference for Freestyle cleanup. Camera, depth, normals, object IDs — all exact. Tags: blender, freestyle, pipeline, render-passes
- 2026-04-11: [SIGGRAPH Research for IllTool](references/research-siggraph-vectorization-2024.md) — Curated SIGGRAPH/TOG papers (2020-2025) for vectorization, depth, sketch cleanup, differentiable rendering. Tags: siggraph, research, ml
